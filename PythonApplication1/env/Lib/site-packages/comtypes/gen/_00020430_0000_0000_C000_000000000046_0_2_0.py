...
IFontDisp = Font
__all__ = [ 'OLE_YSIZE_HIMETRIC', 'Unchecked', 'FONTITALIC',
           'OLE_HANDLE', 'OLE_XSIZE_PIXELS', 'FONTNAME',
           'FONTUNDERSCORE', 'Font', 'FONTBOLD', 'Monochrome',
           'LoadPictureConstants', 'Picture', 'OLE_CANCELBOOL',
           'OLE_YPOS_CONTAINER', 'FontEvents', 'OLE_TRISTATE', 'Gray',
           'OLE_XPOS_PIXELS', 'Color', 'FONTSTRIKETHROUGH',
           'FONTSIZE', 'OLE_XPOS_CONTAINER', 'OLE_YPOS_PIXELS',
           'OLE_YSIZE_CONTAINER', 'IFont', 'IFontEventsDisp',
           'IPicture', 'OLE_XSIZE_CONTAINER', 'OLE_ENABLEDEFAULTBOOL',
           'VgaColor', 'OLE_YPOS_HIMETRIC', 'OLE_XPOS_HIMETRIC',
           'IPictureDisp', 'Default', 'OLE_COLOR', 'OLE_YSIZE_PIXELS',
           'StdFont', 'Checked', 'IFontDisp', 'OLE_XSIZE_HIMETRIC',
           'StdPicture', 'OLE_OPTEXCLUSIVE']
